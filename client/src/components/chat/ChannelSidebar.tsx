...
import type { Channel, Section, DirectMessageChannel, User as UserType } from "@db/schema";
            ...
            <CollapsibleContent className="space-y-4 mt-2">
              <div className="px-2 space-y-1">
                {sortedUsers.map((userItem) => {
                  const isOnline = isUserOnline(userItem.lastActiveAt);
                    ...
                    >
                      ...
                      {userItem.id !== user?.id && (
                        <Button
                          ...
                          onClick={() => createDMMutation.mutate(userItem.id)}
                        >
